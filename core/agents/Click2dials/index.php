...
<body oncontextmenu="return false">
            <div class="banner-wrap" id="banner-wrap">
                ...
                <font color="white">
                  <div class='Row' style='display: table;table-layout: fixed;border-spacing: 1px;position: relative;float: right;'>
      ...
      <div class="content-wrap" id="content-wrap">
                                ...
                                <tr>
                                    ...
                                    <div class="col-sm small">
                                      <a href="#">
                                        <div class="icon" id="icon1" onclick='popupSocialMedia("../social/socialMediaPop.php?tbl=whatsapp&user=henuteka");'>
                                            ...
                                            <span class="notification-count">63</span> 
                                        </div>
                                      </a>
                                    </div>
                                  </td>
                                  <td>
                                    <div class="col-sm small"></div>
                                      <a href="#">
                                        <div class="icon" id="icon1" onclick='popupSocialMedia("../social/socialMediaPop.php?tbl=facebook&user=henuteka");'>
            ...
            <!--Footer starts here-->
              <div class="footer" id="footer"><div style="display: inline-block;float:left;"> &copy;Powered by YathuPBX&trade;</div><div style="display: inline-block;float:right;"><i class="fa fa-registered" aria-hidden="true" style="padding-top: 10px;opacity: 0.8;">&nbsp;SIPLINE Omni-Channel Platform</i></div></div>
            <!--Footer ends here-->
